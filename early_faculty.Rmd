...
support_levels <- c("Dept Startup", "AASLD CDA", "ACG CDA", "CCF CDA", "NIH KL2", "NIH K23", "NIH K08",  "VA IIR", "NIH U01")

faculty <- read_excel('data/Early Career Fac Jun2021.xlsx',  sheet = 'Sheet1') %>% 
  clean_names() %>% 
